...
//
//
void TermClearScreen(void) { printf("\033[2J\033[1;1f"); }

void TermHideCursor(void) { printf("\033[?25l"); }

void TermShowCursor(void) { printf("\033[?25h"); }

/// \brief Move cursor to the given `row` and `col`.
void TermMoveCursor(int row, int col) { printf("%c[%d;%df", 0x1B, row + 1, col + 1); }
